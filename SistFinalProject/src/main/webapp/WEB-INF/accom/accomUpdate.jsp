		...
		<div class="accom_insert_box" align="center">
            ...
            <tr>
                ...
                <td valign="middle"><input type="text" class="form-control"
                                           ...
                                           style="width: 30vh; height: 5vh;" value="${dto.accom_name }"></td>
            </tr>
            ...
            <tr>
                ...
                <td valign="middle">
                    ...
                    <input type="hidden" name="accom_latitude" id="accom_latitude" value="${dto.accom_latitude }">
                    <input type="hidden" name="accom_longitude" id="accom_longitude" value="${dto.accom_longitude }">
                    <!-- 상세주소 주소 넘기기 -->
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" name="accom_hashtag" id="accom_hashtag" value=${dto.accom_hashtag }>
