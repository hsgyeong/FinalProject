...
<body>
	...
	<!-- 	<form action="memberLogin" method="post" >
			...
			<tr>
				...
				<br><br>
				<div class="select">
				<button type="button" class="btn" id="person" style="background-color: #f7323f; color: white; 
							font-family: 'Jalnan'; width:50%;">개인</button>
				&nbsp;&nbsp;&nbsp;
				<button type="button" class="btn" id="business" style="background-color: #f7323f; color: white; 
							font-family: 'Jalnan'; width:50%;">사업자</button>
				</div>	
				</td>
			</tr>		
			...
			<tr>
				...
				&nbsp;&nbsp;
				<input type="text" name="business_id" id="bNum" required="required" style="width: 190px;"
					class="form-control" ></span>
				<br>
				<span class="businessPass">비밀번호&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="password" name="business_pass" required="required" style="width: 190px;"
					class="form-control" ></span>
			</div>	
				</td>
		</tr>	
		...
		<form action="memberLogin" method="post">
			<table class="table .table-borderless tb" style="width: 700px;" id="memberLogin">
			<tr>
				<td>
				<div class="logtitle">
				<h2><a href="/"	style="font-family: 'Jalnan'; text-align: center;
				...
				<br><br>
				<div class="select">
				<button type="button" class="btn" id="personBtn" style="background-color: #f7323f; color: white; 
							font-family: 'Jalnan'; width:50%;">개인</button>
				&nbsp;&nbsp;&nbsp;
				<button type="button" class="btn" id="businessBtn" style="background-color: #f7323f; color: white; 
							font-family: 'Jalnan'; width:50%;">사업자</button>
				</div>	
				</td>
			</tr>		
		...
		<form action="businessLogin" method="post">
			<table class="table .table-borderless tb" style="width: 700px;" id="businessLogin">
			<tr>
				<td>
				<div class="logtitle">
				<h2><a href="/"	style="font-family: 'Jalnan'; text-align: center;
